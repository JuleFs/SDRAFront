...
export class ResultadosComponent implements OnInit, AfterViewInit {
  ...
  obtenerPerfilAlumno() {
    ...
    this.servicio.obtenerPerfil(
      ...
      if (letraActivoReflexivo === 'A') {
        ...
        this.preferencias.push(this.calcularPreferencia(Number(this.activo), this.translate.instant('results.active'), this.translate.instant('results.active') + '/' + this.translate.instant('results.reflective')));
        ...
        this.preferencias.push(this.calcularPreferencia(Number(this.reflexivo), this.translate.instant('results.reflective'), this.translate.instant('results.active') + '/' + this.translate.instant('results.reflective')));
      ...
      if (letraSensorialIntuitivo === 'A') {
        ...
        this.preferencias.push(this.calcularPreferencia(Number(this.sensorial), this.translate.instant('results.sensory'), this.translate.instant('results.sensory') + '/' + this.translate.instant('results.intuitive')));
        ...
        this.preferencias.push(this.calcularPreferencia(Number(this.intuitivo), this.translate.instant('results.intuitive'), this.translate.instant('results.sensory') + '/' + this.translate.instant('results.intuitive')));
      ...
      if (letraVisualVerbal === 'A') {
        ...
        this.preferencias.push(this.calcularPreferencia(Number(this.visual), this.translate.instant('results.visual'), this.translate.instant('results.visual') + '/' + this.translate.instant('results.verbal')));
        ...
        this.preferencias.push(this.calcularPreferencia(Number(this.verbal), this.translate.instant('results.verbal'), this.translate.instant('results.visual') + '/' + this.translate.instant('results.verbal')));
      ...
      if (letraSecuencialGlobal === 'A') {
        ...
        this.preferencias.push(this.calcularPreferencia(Number(this.secuencial), this.translate.instant('results.sequential'), this.translate.instant('results.sequential') + '/' + this.translate.instant('results.global')));
        ...
        this.preferencias.push(this.calcularPreferencia(Number(this.global), this.translate.instant('results.global'), this.translate.instant('results.sequential') + '/' + this.translate.instant('results.global')));
  ...
  private calcularPreferencia(valor: number, dimPredominante: string, dimensiones: string): string {
    if (valor >= 1 && valor <= 3) {
